...
class TPEnet_a(nn.Module):
    ...
    def __init__(self, n_classes_ins = 16, n_classes_seg = 3):
        ...
        ch_output_fc_hardnet_b = n_classes_ins      # output of Conv-Final

        self.n_classes_ins = n_classes_ins
        ###================================================================================================
    ...
    def forward(self, x):
        ...
        ###================================================================================================
        # for it in self.rpnet_decoder_centerline.weight[0]:
        #     print(it[0][0])
...
########################################################################################################################
### 5. TPEnet_b (Contains instance, centerness, and segmentation branch)
########################################################################################################################
class TPEnet_b(nn.Module):
    ############################################################################################################
    ### rpnet_c::__init__()
    ############################################################################################################
    def __init__(self, n_classes_ins = 16, n_classes_seg = 3):
        # self.device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
        super(TPEnet_b, self).__init__()
